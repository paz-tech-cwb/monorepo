...
interface LeaderCoLeaderPickerProps {
  users: UserOption[]
...
export function LeaderCoLeaderPicker({
  users,
  leaderId,
  coLeaderId,
  onLeaderChange,
  onCoLeaderChange,
  leaderLabel = "Líder",
  coLeaderLabel = "Co-líder",
}: LeaderCoLeaderPickerProps) {
  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      <div className="space-y-1">
        ...
        <Select
          value={toVal(leaderId)}
          onValueChange={(v) => onLeaderChange(parse(v))}
        >
          <SelectTrigger>
      ...
      <div className="space-y-1">
        ...
        <Select
          value={toVal(coLeaderId)}
          onValueChange={(v) => onCoLeaderChange(parse(v))}
        >
          <SelectTrigger>
            <SelectValue placeholder="Selecionar" />
          </SelectTrigger>
