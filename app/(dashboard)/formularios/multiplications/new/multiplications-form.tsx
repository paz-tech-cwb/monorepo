...
const schema = z.object({
  ...
  source_life_group_id: z.coerce.number().int().positive("Obrigatório"),
  ...
  new_leader_id: z.coerce.number().int().positive("Obrigatório"),
  host_id: z.coerce.number().int().positive("Obrigatório"),
  address: z.string().min(1, "Obrigatório"),
  leader_phone: z.string().regex(/^\+?[0-9]{8,15}$/, "Formato: +5511999999999"),
  ...
  new_life_group_id: z.coerce.number().int().positive().optional().nullable(),
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          <Label>ID do LG de origem *</Label>
          <Input {...register("source_life_group_id")} type="number" />
        ...
        <div>
          <Label>ID do novo líder *</Label>
          <Input {...register("new_leader_id")} type="number" />
        ...
        <div>
          ...
          <Input {...register("leader_phone")} placeholder="+5511999999999" />
        ...
        <div>
          <Label>ID do novo LG (se já criado)</Label>
          <Input {...register("new_life_group_id")} type="number" />
        </div>
        <div>
