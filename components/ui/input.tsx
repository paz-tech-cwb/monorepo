  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-ring focus-visible:ring-ring/5 focus-visible:ring-1",
        "aria-invalid:ring-destructive/10 dark:aria-invalid:ring-destructive/20 aria-invalid:border-destructive",
        className
      )}
      {...props}
    />
