...
export class Conversion {
  ...
  @Column({ type: 'varchar', length: 255, nullable: true }) street:
    | string
    | null;
  @Column({ type: 'varchar', length: 180, nullable: true }) neighborhood:
    | string
    | null;
  @Column({ type: 'varchar', length: 180, nullable: true }) city: string | null;
  @Column({
    name: 'culto_attendance',
    type: 'varchar',
    length: 30,
    nullable: true,
  })
  cultoAttendance: string | null;
  @Column({
    name: 'life_group_status',
    type: 'varchar',
    length: 30,
    nullable: true,
  })
  lifeGroupStatus: string | null;
  @Column({
