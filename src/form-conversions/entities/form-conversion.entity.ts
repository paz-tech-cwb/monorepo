...
export class FormConversion {
  ...
  @Column({ name: 'decision_type', type: 'varchar', length: 20 }) decisionType: string;
  @Column({ name: 'how_met_church', type: 'varchar', length: 40 }) howMetChurch: string;
  @Column({ name: 'how_met_church_other', type: 'varchar', length: 180, nullable: true }) howMetChurchOther: string | null;
  ...
  @Column({ name: 'attendance_count', type: 'varchar', length: 40 }) attendanceCount: string;
  @Column({ name: 'life_group_status', type: 'varchar', length: 40 }) lifeGroupStatus: string;
  @Column({ name: 'life_group_leader_or_name', type: 'varchar', length: 180, nullable: true }) lifeGroupLeaderOrName: string | null;
