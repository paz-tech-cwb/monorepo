...
import { NotificationSender, ResendNotificationSender } from './services/notification-sender';
import { User } from '../users/entities/user.entity';
import { LifeGroup } from '../life-groups/entities/life-group.entity';

@Module({
  imports: [TypeOrmModule.forFeature([FormSubmissionAuditLog, ChurchSetting, User, LifeGroup])],
  providers: [
