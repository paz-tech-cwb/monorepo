...
export class SectorSupervisorReport {
  ...
  @Column({ name: 'life_groups_visited', type: 'int', array: true, default: () => "'{}'" })
  lifeGroupsVisited: number[];
  @Column({ name: 'leaders_pastored', type: 'int', array: true, default: () => "'{}'" })
  leadersPastored: number[];
  @Column({ name: 'multiplication_candidates', type: 'int', array: true, default: () => "'{}'" })
